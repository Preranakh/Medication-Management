...
import com.preranatest.medmanage.alarm.ReminderActivity;
import com.preranatest.medmanage.alarm.ReminderFragment;
import com.preranatest.medmanage.data.source.MedicineAlarm;
import com.preranatest.medmanage.data.source.Pills;
import com.preranatest.medmanage.views.DayViewCheckBox;
import com.preranatest.medmanage.views.RobotoBoldTextView;
...
public class AddMedicineFragment extends Fragment implements AddMedicineContract.View {
    ...
    RobotoBoldTextView tvmedmanage;
    ...
    private void showTimePicker() {
        ...
        mTimePicker = new TimePickerDialog(getContext(), new TimePickerDialog.OnTimeSetListener() {
            ...
            public void onTimeSet(TimePicker timePicker, int selectedHour, int selectedMinute) {
                ...
                tvmedmanage.setText(String.format(Locale.getDefault(), "%d:%d", selectedHour, selectedMinute));
            }
    ...
    private void setCurrentTime() {
        ...
        tvmedmanage.setText(String.format(Locale.getDefault(), "%d:%d", hour, minute));
    }
